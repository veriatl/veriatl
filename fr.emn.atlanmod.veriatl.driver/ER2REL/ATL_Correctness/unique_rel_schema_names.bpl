...
forall r1,r2:ref :: {read($tarHeap,r1,alloc),read($tarHeap,r2,alloc)}
  Seq#Contains(Fun#LIB#AllInstanceFrom($tarHeap, REL$RELSchema), r1) && Seq#Contains(Fun#LIB#AllInstanceFrom($tarHeap, REL$RELSchema), r2)
     ==> r1 != r2 ==> read($tarHeap, r1, REL$RELSchema.name) != read($tarHeap, r2, REL$RELSchema.name)
