...
const unique UML$Element: ClassName extends UML$null complete;
...
const unique UML$NamedElement.visibility: Field VisibilityKind;
...
const unique UML$ElementImport.visibility: Field VisibilityKind;
...
const unique UML$PackageImport.visibility: Field VisibilityKind;
...
const unique UML$Association.isDerived: Field Boolean;
...
const unique UML$Classifier.isAbstract: Field Boolean;
...
const unique UML$RedefinableElement.isLeaf: Field Boolean;
...
const unique UML$Generalization.isSubstitutable: Field Boolean;
...
const unique UML$GeneralizationSet.isCovering: Field Boolean;
const unique UML$GeneralizationSet.isDisjoint: Field Boolean;
...
const unique UML$Feature.isStatic: Field Boolean;
...
const unique UML$Parameter.direction: Field ParameterDirectionKind;
const unique UML$Parameter.default: Field String;
const unique UML$Parameter.defaultValue: Field ref;
const unique UML$Parameter.isException: Field Boolean;
const unique UML$Parameter.isStream: Field Boolean;
const unique UML$Parameter.effect: Field ParameterEffectKind;
const unique UML$MultiplicityElement: ClassName extends UML$Element complete;
const unique UML$MultiplicityElement.isOrdered: Field Boolean;
const unique UML$MultiplicityElement.isUnique: Field Boolean;
const unique UML$MultiplicityElement.upper: Field UnlimitedNatural;
const unique UML$MultiplicityElement.lower: Field Integer;
...
const unique UML$Property.isDerived: Field Boolean;
const unique UML$Property.isDerivedUnion: Field Boolean;
const unique UML$Property.default: Field String;
const unique UML$Property.aggregation: Field AggregationKind;
const unique UML$Property.isComposite: Field Boolean;
...
const unique UML$Operation.isQuery: Field Boolean;
const unique UML$Operation.isOrdered: Field Boolean;
const unique UML$Operation.isUnique: Field Boolean;
const unique UML$Operation.lower: Field Integer;
const unique UML$Operation.upper: Field UnlimitedNatural;
...
const unique UML$BehavioralFeature.isAbstract: Field Boolean;
const unique UML$BehavioralFeature.method: Field ref;
const unique UML$BehavioralFeature.concurrency: Field CallConcurrencyKind;
...
const unique UML$Behavior.isReentrant: Field Boolean;
...
const unique UML$Class.isActive: Field Boolean;
...
const unique UML$BehavioredClassifier.ownedTrigger: Field ref;
...
const unique UML$Transition.kind: Field TransitionKind;
...
const unique UML$Port.isBehavior: Field Boolean;
const unique UML$Port.isService: Field Boolean;
...
const unique UML$State.isComposite: Field Boolean;
const unique UML$State.isOrthogonal: Field Boolean;
const unique UML$State.isSimple: Field Boolean;
const unique UML$State.isSubmachineState: Field Boolean;
...
const unique UML$Pseudostate.kind: Field PseudostateKind;
...
const unique UML$Profile.ownedStereotype: Field ref;
...
const unique UML$StructuralFeature.isReadOnly: Field Boolean;
...
const unique UML$Collaboration: ClassName extends UML$BehavioredClassifier,UML$StructuredClassifier complete;
...
const unique UML$ClassifierTemplateParameter.allowSubstitutable: Field Boolean;
...
const unique UML$ProfileApplication.isStrict: Field Boolean;
...
const unique UML$LiteralInteger.value: Field Integer;
...
const unique UML$LiteralBoolean.value: Field Boolean;
...
const unique UML$LiteralUnlimitedNatural.value: Field UnlimitedNatural;
...
const unique UML$StructuredActivityNode.mustIsolate: Field Boolean;
const unique UML$StructuredActivityNode.node: Field ref;
const unique UML$ActivityGroup: ClassName extends UML$Element complete;
...
const unique UML$Activity.isReadOnly: Field Boolean;
const unique UML$Activity.edge: Field ref;
const unique UML$Activity.partition: Field ref;
const unique UML$Activity.isSingleExecution: Field Boolean;
...
const unique UML$ActivityPartition: ClassName extends UML$NamedElement,UML$ActivityGroup complete;
const unique UML$ActivityPartition.isDimension: Field Boolean;
const unique UML$ActivityPartition.isExternal: Field Boolean;
...
const unique UML$ObjectNode.ordering: Field ObjectNodeOrderingKind;
const unique UML$ObjectNode.isControlType: Field Boolean;
...
const unique UML$Pin.isControl: Field Boolean;
...
const unique UML$CallAction.isSynchronous: Field Boolean;
...
const unique UML$Message.messageKind: Field MessageKind;
const unique UML$Message.messageSort: Field MessageSort;
...
const unique UML$OccurrenceSpecification.event: Field ref;
...
const unique UML$ExecutionEvent: ClassName extends UML$Event complete;
const unique UML$CreationEvent: ClassName extends UML$Event complete;
const unique UML$DestructionEvent: ClassName extends UML$Event complete;
const unique UML$SendOperationEvent: ClassName extends UML$MessageEvent complete;
const unique UML$SendOperationEvent.operation: Field ref;
const unique UML$MessageEvent: ClassName extends UML$Event complete;
   axiom (forall r: ref :: dtype(r)!= UML$MessageEvent);
const unique UML$SendSignalEvent: ClassName extends UML$MessageEvent complete;
const unique UML$SendSignalEvent.signal: Field ref;
...
const unique UML$ReceiveOperationEvent: ClassName extends UML$MessageEvent complete;
const unique UML$ReceiveOperationEvent.operation: Field ref;
const unique UML$ReceiveSignalEvent: ClassName extends UML$MessageEvent complete;
const unique UML$ReceiveSignalEvent.signal: Field ref;
...
const unique UML$ObjectFlow.isMulticast: Field Boolean;
const unique UML$ObjectFlow.isMultireceive: Field Boolean;
...
const unique UML$Component.isIndirectlyInstantiated: Field Boolean;
...
const unique UML$CombinedFragment.interactionOperator: Field InteractionOperatorKind;
...
const unique UML$Continuation.setting: Field Boolean;
...
const unique UML$DestroyObjectAction.isDestroyLinks: Field Boolean;
const unique UML$DestroyObjectAction.isDestroyOwnedObjects: Field Boolean;
...
const unique UML$RemoveStructuralFeatureValueAction.isRemoveDuplicates: Field Boolean;
...
const unique UML$AddStructuralFeatureValueAction.isReplaceAll: Field Boolean;
...
const unique UML$LinkEndCreationData.isReplaceAll: Field Boolean;
...
const unique UML$LinkEndDestructionData.isDestroyDuplicates: Field Boolean;
...
const unique UML$TimeConstraint.firstEvent: Field Boolean;
...
const unique UML$DurationConstraint.firstEvent: Field Boolean;
...
const unique UML$TimeObservation.firstEvent: Field Boolean;
...
const unique UML$DurationObservation.firstEvent: Field Boolean;
...
const unique UML$TimeEvent.isRelative: Field Boolean;
...
const unique UML$AddVariableValueAction.isReplaceAll: Field Boolean;
...
const unique UML$RemoveVariableValueAction.isRemoveDuplicates: Field Boolean;
...
const unique UML$ReclassifyObjectAction.isReplaceAll: Field Boolean;
...
const unique UML$ReadIsClassifiedObjectAction.isDirect: Field Boolean;
...
const unique UML$AcceptEventAction.isUnmarshall: Field Boolean;
...
const unique UML$ReduceAction.isOrdered: Field Boolean;
...
const unique UML$JoinNode.isCombineDuplicate: Field Boolean;
...
const unique UML$ConditionalNode.isDeterminate: Field Boolean;
const unique UML$ConditionalNode.isAssured: Field Boolean;
...
const unique UML$LoopNode.isTestedFirst: Field Boolean;
...
const unique UML$ExpansionRegion.mode: Field ExpansionKind;
...
axiom classifierTable[_UML, _ExecutionEvent] == UML$ExecutionEvent;
axiom classifierTable[_UML, _CreationEvent] == UML$CreationEvent;
axiom classifierTable[_UML, _DestructionEvent] == UML$DestructionEvent;
axiom classifierTable[_UML, _SendOperationEvent] == UML$SendOperationEvent;
axiom classifierTable[_UML, _MessageEvent] == UML$MessageEvent;
axiom classifierTable[_UML, _SendSignalEvent] == UML$SendSignalEvent;
...
axiom classifierTable[_UML, _ReceiveOperationEvent] == UML$ReceiveOperationEvent;
axiom classifierTable[_UML, _ReceiveSignalEvent] == UML$ReceiveSignalEvent;
...
function valid_src_model($h: HeapType): bool{
	...
	&&(forall __feature : ref ::
	 ...
	 true &&
	    (read($h, __feature, UML$Feature.featuringClassifier)==null || (read($h, read($h, __feature, UML$Feature.featuringClassifier), alloc) && dtype(read($h, __feature, UML$Feature.featuringClassifier)) <: class._System.array &&
	       (forall __i: int :: 0<=__i && __i<_System.array.Length(read($h, __feature, UML$Feature.featuringClassifier)) ==> 
	         ($Unbox(read($h, read($h, __feature, UML$Feature.featuringClassifier), IndexField(__i))): ref !=null 
	         && read($h, $Unbox(read($h, read($h, __feature, UML$Feature.featuringClassifier), IndexField(__i))): ref, alloc)
	         && dtype($Unbox(read($h, read($h, __feature, UML$Feature.featuringClassifier), IndexField(__i))): ref)<:UML$Classifier) ) ) )
	  )
	)
	...
	&&(forall __behavioredclassifier : ref ::
	  (__behavioredclassifier!=null && read($h, __behavioredclassifier, alloc) && dtype(__behavioredclassifier) <: UML$BehavioredClassifier ==> 
	    ...
	    (read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger)==null || (read($h, read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger), alloc) && dtype(read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger)) <: class._System.array &&
	       (forall __i: int :: 0<=__i && __i<_System.array.Length(read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger)) ==> 
	         ($Unbox(read($h, read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger), IndexField(__i))): ref !=null 
	         && read($h, $Unbox(read($h, read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger), IndexField(__i))): ref, alloc)
	         && dtype($Unbox(read($h, read($h, __behavioredclassifier, UML$BehavioredClassifier.ownedTrigger), IndexField(__i))): ref)<:UML$Trigger) ) ) )
	  )
	)
	...
	&&(forall __profile : ref ::
	  (__profile!=null && read($h, __profile, alloc) && dtype(__profile) <: UML$Profile ==> 
	    (read($h, __profile, UML$Profile.ownedStereotype)==null || (read($h, read($h, __profile, UML$Profile.ownedStereotype), alloc) && dtype(read($h, __profile, UML$Profile.ownedStereotype)) <: class._System.array &&
	       (forall __i: int :: 0<=__i && __i<_System.array.Length(read($h, __profile, UML$Profile.ownedStereotype)) ==> 
	         ($Unbox(read($h, read($h, __profile, UML$Profile.ownedStereotype), IndexField(__i))): ref !=null 
	         && read($h, $Unbox(read($h, read($h, __profile, UML$Profile.ownedStereotype), IndexField(__i))): ref, alloc)
	         && dtype($Unbox(read($h, read($h, __profile, UML$Profile.ownedStereotype), IndexField(__i))): ref)<:UML$Stereotype) ) ) )&&
	  ...
	  (__interactionuse!=null && read($h, __interactionuse, alloc) && dtype(__interactionuse) <: UML$InteractionUse ==> 
	    ...
	    (read($h, __interactionuse, UML$InteractionUse.argument)==null || (read($h, read($h, __interactionuse, UML$InteractionUse.argument), alloc) && dtype(read($h, __interactionuse, UML$InteractionUse.argument)) <: class._System.array &&
	       (forall __i: int :: 0<=__i && __i<_System.array.Length(read($h, __interactionuse, UML$InteractionUse.argument)) ==> 
	         ...
	         && dtype($Unbox(read($h, read($h, __interactionuse, UML$InteractionUse.argument), IndexField(__i))): ref)<:UML$Action) ) ) )
	  )
	)
	&&(forall __gate : ref ::
	...
	&&(forall __occurrencespecification : ref ::
	  (__occurrencespecification!=null && read($h, __occurrencespecification, alloc) && dtype(__occurrencespecification) <: UML$OccurrenceSpecification ==> 
	    ...
	    (read($h, __occurrencespecification, UML$OccurrenceSpecification.event)!=null && read($h, read($h, __occurrencespecification, UML$OccurrenceSpecification.event) ,alloc) ==>
	       dtype(read($h, __occurrencespecification, UML$OccurrenceSpecification.event)) <: UML$Event ) &&
	...
	&&(forall __executionevent : ref ::
	  (__executionevent!=null && read($h, __executionevent, alloc) && dtype(__executionevent) <: UML$ExecutionEvent ==> true
	  )
	)
	&&(forall __creationevent : ref ::
	  (__creationevent!=null && read($h, __creationevent, alloc) && dtype(__creationevent) <: UML$CreationEvent ==> true
	  )
	)
	&&(forall __destructionevent : ref ::
	  (__destructionevent!=null && read($h, __destructionevent, alloc) && dtype(__destructionevent) <: UML$DestructionEvent ==> true
	  )
	)
	&&(forall __sendoperationevent : ref ::
	  (__sendoperationevent!=null && read($h, __sendoperationevent, alloc) && dtype(__sendoperationevent) <: UML$SendOperationEvent ==> 
	    (read($h, __sendoperationevent, UML$SendOperationEvent.operation)!=null && read($h, read($h, __sendoperationevent, UML$SendOperationEvent.operation) ,alloc) ==>
	       dtype(read($h, __sendoperationevent, UML$SendOperationEvent.operation)) <: UML$Operation ) 
	  )
	)
	...
	&&(forall __sendsignalevent : ref ::
	  (__sendsignalevent!=null && read($h, __sendsignalevent, alloc) && dtype(__sendsignalevent) <: UML$SendSignalEvent ==> 
	    (read($h, __sendsignalevent, UML$SendSignalEvent.signal)!=null && read($h, read($h, __sendsignalevent, UML$SendSignalEvent.signal) ,alloc) ==>
	       dtype(read($h, __sendsignalevent, UML$SendSignalEvent.signal)) <: UML$Signal ) 
	  )
	)
	...
	&&(forall __receiveoperationevent : ref ::
	  (__receiveoperationevent!=null && read($h, __receiveoperationevent, alloc) && dtype(__receiveoperationevent) <: UML$ReceiveOperationEvent ==> 
	    (read($h, __receiveoperationevent, UML$ReceiveOperationEvent.operation)!=null && read($h, read($h, __receiveoperationevent, UML$ReceiveOperationEvent.operation) ,alloc) ==>
	       dtype(read($h, __receiveoperationevent, UML$ReceiveOperationEvent.operation)) <: UML$Operation ) 
	  )
	)
	&&(forall __receivesignalevent : ref ::
	  (__receivesignalevent!=null && read($h, __receivesignalevent, alloc) && dtype(__receivesignalevent) <: UML$ReceiveSignalEvent ==> 
	    (read($h, __receivesignalevent, UML$ReceiveSignalEvent.signal)!=null && read($h, read($h, __receivesignalevent, UML$ReceiveSignalEvent.signal) ,alloc) ==>
	       dtype(read($h, __receivesignalevent, UML$ReceiveSignalEvent.signal)) <: UML$Signal ) 
	  )
	)
	&&(forall __actor : ref ::
