...
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$Pin ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$Pin  &&
       printGuard_CopyPin($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
...
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$ExecutionEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$ExecutionEvent  &&
       printGuard_CopyExecutionEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$CreationEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$CreationEvent  &&
       printGuard_CopyCreationEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$DestructionEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$DestructionEvent  &&
       printGuard_CopyDestructionEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$SendOperationEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$SendOperationEvent  &&
       printGuard_CopySendOperationEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$SendSignalEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$SendSignalEvent  &&
       printGuard_CopySendSignalEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
...
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$ReceiveOperationEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$ReceiveOperationEvent  &&
       printGuard_CopyReceiveOperationEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
  t!=null && read($t, t, alloc) && dtype(t) == UMLs$ReceiveSignalEvent ==>
    
    (exists  s: ref  ::
       s!=null && read($s, s, alloc) && dtype(s) <: UML$ReceiveSignalEvent  &&
       printGuard_CopyReceiveSignalEvent($s,  s ) && 
      	 getTarsBySrcs(Seq#Singleton( s  ))  == t )
)
&&
(forall t: ref :: 
