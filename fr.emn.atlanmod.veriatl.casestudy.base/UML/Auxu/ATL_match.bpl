...
procedure CopyComment_matchAll() returns ();
  ...
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
...
procedure CopyPin_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$Pin  ==>
      printGuard_CopyPin( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$Pin  ==>
  	      printGuard_CopyPin( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$Pin)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$Pin && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$Pin
  		&& printGuard_CopyPin( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopyPin( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$Pin
  }  
...
procedure CopyExecutionEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$ExecutionEvent  ==>
      printGuard_CopyExecutionEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$ExecutionEvent  ==>
  	      printGuard_CopyExecutionEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$ExecutionEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$ExecutionEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$ExecutionEvent
  		&& printGuard_CopyExecutionEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopyExecutionEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$ExecutionEvent
  }  
  
procedure CopyCreationEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$CreationEvent  ==>
      printGuard_CopyCreationEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$CreationEvent  ==>
  	      printGuard_CopyCreationEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$CreationEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$CreationEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$CreationEvent
  		&& printGuard_CopyCreationEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopyCreationEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$CreationEvent
  }  
  
procedure CopyDestructionEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$DestructionEvent  ==>
      printGuard_CopyDestructionEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$DestructionEvent  ==>
  	      printGuard_CopyDestructionEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$DestructionEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$DestructionEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$DestructionEvent
  		&& printGuard_CopyDestructionEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopyDestructionEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$DestructionEvent
  }  
  
procedure CopySendOperationEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$SendOperationEvent  ==>
      printGuard_CopySendOperationEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$SendOperationEvent  ==>
  	      printGuard_CopySendOperationEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$SendOperationEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$SendOperationEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$SendOperationEvent
  		&& printGuard_CopySendOperationEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopySendOperationEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$SendOperationEvent
  }  
  
procedure CopySendSignalEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$SendSignalEvent  ==>
      printGuard_CopySendSignalEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$SendSignalEvent  ==>
  	      printGuard_CopySendSignalEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$SendSignalEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$SendSignalEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$SendSignalEvent
  		&& printGuard_CopySendSignalEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopySendSignalEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$SendSignalEvent
  }  
...
procedure CopyReceiveOperationEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$ReceiveOperationEvent  ==>
      printGuard_CopyReceiveOperationEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$ReceiveOperationEvent  ==>
  	      printGuard_CopyReceiveOperationEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$ReceiveOperationEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$ReceiveOperationEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$ReceiveOperationEvent
  		&& printGuard_CopyReceiveOperationEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopyReceiveOperationEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$ReceiveOperationEvent
  }  
  
procedure CopyReceiveSignalEvent_matchAll() returns ();
  // detect rule conflict
  requires (forall  s: ref  ::
     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$ReceiveSignalEvent  ==>
      printGuard_CopyReceiveSignalEvent( $srcHeap ,  s ) ==> 
        (  getTarsBySrcs(Seq#Singleton( s  )) ==null || !read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc))
  );
  modifies  $tarHeap ,  $linkHeap ;
  // rule matching outcome
  ensures (forall  s: ref  ::
  	     s!=null && read( $srcHeap , s, alloc) && dtype(s) <: UML$ReceiveSignalEvent  ==>
  	      printGuard_CopyReceiveSignalEvent( $srcHeap ,  s ) ==> 
  	        (    getTarsBySrcs(Seq#Singleton( s  )) !=null 
  	          && read( $tarHeap ,  getTarsBySrcs(Seq#Singleton( s  )) , alloc)
  	          && dtype( getTarsBySrcs(Seq#Singleton( s  )) ) <: UMLs$ReceiveSignalEvent)
  );
  // frame condition
  ensures (forall<alpha> __$o: ref, __$f: Field alpha ::
  	(__$o == null 
  	|| read( $tarHeap , __$o, __$f) == read(old( $tarHeap ), __$o, __$f) 
  	||  ( dtype(__$o) <: UMLs$ReceiveSignalEvent && __$f==alloc && Seq#Length(getTarsBySrcs_inverse(__$o))==1
  		&& dtype(Seq#Index(getTarsBySrcs_inverse(__$o), 0)) <: UML$ReceiveSignalEvent
  		&& printGuard_CopyReceiveSignalEvent( $srcHeap , Seq#Index(getTarsBySrcs_inverse(__$o), 0)) )
  	 )
  );
  free ensures $HeapSucc(old( $tarHeap ),  $tarHeap );
  free ensures $HeapSucc(old( $linkHeap ),  $linkHeap );
...
function printGuard_CopyReceiveSignalEvent( __$hp : HeapType,  s: ref ): bool
  { 
  	dtype(s) <: UML$ReceiveSignalEvent
  }  
