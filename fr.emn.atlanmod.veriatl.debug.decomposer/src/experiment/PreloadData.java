...
public class PreloadData {
	...
	public static HashMap<String, Integer> initPostTimeSep() {
		...
		result.put("Parameter_stream_and_exception",189551);
		result.put("ObjectFlow_is_multicast_or_is_multireceive",186558);
		result.put("InformationItem_not_instantiable",180896);
		result.put("AcceptCallAction_unmarshall",139891);
		result.put("InitialNode_no_incoming_edges",188088);
		result.put("ActivityParameterNode_no_edges",180965);
		result.put("FinalState_no_regions",186334);
		result.put("ForkNode_one_incoming_edge",180561);
		result.put("ValuePin_no_incoming_edges",64055);
		result.put("InitialNode_control_edges",185281);
		result.put("MergeNode_one_outgoing_edge",188270);
		result.put("JoinNode_one_outgoing_edge",185987);
		result.put("FinalState_no_outgoing_transitions",183617);
		result.put("AcceptEventAction_no_output_pins",186459);
		result.put("State_submachine_or_regions",190570);
		result.put("Extension_is_binary",187877);
		result.put("ConditionalNode_no_input_pins",184345);
		result.put("Reception_same_name_as_signal",190197);
		result.put("Property_derived_union_is_read_only",190783);
		result.put("FinalNode_no_outgoing_edges",189842);
		result.put("Property_derived_union_is_derived",185362);
		result.put("Property_subsetted_property_names",190758);
		result.put("State_composite_states",182740);
		result.put("State_submachine_states",182690);
		result.put("InformationItem_has_no",188431);
		result.put("Enumeration_immutable",181399);
		result.put("Pin_not_unique",182478);
		result.put("AcceptEventAction_no_input_pins",187131);
		result.put("CallAction_synchronous_call",188480);
		result.put("Pin_control_pins",184381);
		result.put("DecisionNode_decision_input_flow_incoming",182596);
		result.put("ActivityParameterNode_has_parameters",187038);
		result.put("StringExpression_operands",187500);
		result.put("Component_no_nested_classifiers",93588);
		result.put("BehavioralFeature_abstract_no_method",189940);
		result.put("Extend_extension_points",190808);
		result.put("LinkAction_not_static",182263);
		result.put("ExecutionSpecification_same_lifeline",190814);
		result.put("CreateObjectAction_classifier_not_association_class",189978);
		result.put("ClassifierTemplateParameter_has_constraining_classifier",184770);
		result.put("Node_internal_structure",185506);
		result.put("StructuralFeatureAction_not_static",183502);
		result.put("InformationFlow_convey_classifiers",180078);
		result.put("ReadLinkObjectEndAction_ends_of_association",180181);
		result.put("CommunicationPath_association_ends",182530);
		result.put("ActionInputPin_input_pin",182589);
		result.put("State_destinations_or_sources_of_transitions",187275);
		result.put("Behavior_feature_of_context_classifier",186588);
		result.put("ActionInputPin_one_output_pin",190076);
		result.put("CreateObjectAction_classifier_not_abstract",195040);
