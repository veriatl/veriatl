...
function printGuard_RS2RS( __$hp : HeapType,  rs1: ref ): bool
  { 
  	(read( __$hp , rs1, HSM$AbstractState.compositeState)==null || !read( __$hp , read( __$hp , rs1, HSM$AbstractState.compositeState), alloc))
  }  
...
function printGuard_T2TB( __$hp : HeapType,  t1: ref , src: ref , trg: ref , c: ref ): bool
  { 
  	!(c == src)  &&  read( __$hp , t1, HSM$Transition.source) == src  &&  read( __$hp , t1, HSM$Transition.target) == trg  &&  read( __$hp , c, HSM$AbstractState.compositeState) == src
  }  
